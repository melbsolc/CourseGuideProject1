...
{
	public class Institutions2TableViewSource : UITableViewSource
	{
		string cellIdentifier = "institutesCellID";

		string[] institutionsArray;

		UIColor[] institutionsColorArray;

		public Institutions2TableViewSource(string[] institutions, UIColor[] colors)
		{
